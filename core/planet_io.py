...
Usage
-----
    from core.planet_io import planet_to_json, planet_from_json, planet_fingerprint
...
def planet_from_dict(d: dict):
    ...
    """
    from core.planet import (Planet, AtmosphereConfig, TerrainConfig,
                              MagneticFieldConfig, OblatenessConfig, MoonConfig,
    ...
    def _atm(raw):
        ...
        return AtmosphereConfig(
            ...
            composition          = AtmosphereComposition[raw["composition"]]
                                   if "composition" in raw else AtmosphereComposition.EARTH_LIKE,
    ...
    def _terrain(raw):
        ...
        return TerrainConfig(
            ...
            terrain_type  = TerrainType[raw["terrain_type"]]
                            if "terrain_type" in raw else TerrainType.FLAT,
    ...
    def _mag(raw):
        ...
        return MagneticFieldConfig(
            ...
            strength              = MagneticFieldStrength[raw["strength"]]
                                    if "strength" in raw else MagneticFieldStrength.MEDIUM,
