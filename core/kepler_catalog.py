...
class CatalogEntry:
    ...
    def to_planet(self):
        ...
        """
        from core.planet import Planet, AtmosphereConfig, AtmosphereComposition
        from core.planet import TerrainConfig, MagneticFieldConfig, OblatenessConfig
        ...
        p = Planet(
            ...
            atmosphere       = AtmosphereConfig(
                ...
                scale_height     = 8500 * (self.equilibrium_temperature_K / 255)
...
_CATALOG_DATA = [
    ...
    CatalogEntry("TRAPPIST-1 b", "TRAPPIST-1",
                 radius_earth=1.116, mass_earth=1.017,
                 orbital_period_d=1.511, semi_major_axis_au=0.01154,
                 star_teff_K=2566, star_radius_sun=0.1192, star_mass_sun=0.0898,
                 star_luminosity=0.000553, reference="Agol+2021"),

    CatalogEntry("TRAPPIST-1 c", "TRAPPIST-1",
                 radius_earth=1.097, mass_earth=1.156,
                 orbital_period_d=2.422, semi_major_axis_au=0.01580,
                 star_teff_K=2566, star_radius_sun=0.1192, star_mass_sun=0.0898,
                 star_luminosity=0.000553, reference="Agol+2021"),

    CatalogEntry("TRAPPIST-1 d", "TRAPPIST-1",
                 radius_earth=0.788, mass_earth=0.297,
                 orbital_period_d=4.050, semi_major_axis_au=0.02228,
                 star_teff_K=2566, star_radius_sun=0.1192, star_mass_sun=0.0898,
                 star_luminosity=0.000553, reference="Agol+2021"),

    CatalogEntry("TRAPPIST-1 e", "TRAPPIST-1",
                 radius_earth=0.920, mass_earth=0.772,
                 orbital_period_d=6.101, semi_major_axis_au=0.02928,
                 star_teff_K=2566, star_radius_sun=0.1192, star_mass_sun=0.0898,
                 star_luminosity=0.000553, reference="Agol+2021"),

    CatalogEntry("TRAPPIST-1 f", "TRAPPIST-1",
                 radius_earth=1.045, mass_earth=0.934,
                 orbital_period_d=9.207, semi_major_axis_au=0.03853,
                 star_teff_K=2566, star_radius_sun=0.1192, star_mass_sun=0.0898,
                 star_luminosity=0.000553, reference="Agol+2021"),

    CatalogEntry("TRAPPIST-1 g", "TRAPPIST-1",
                 radius_earth=1.129, mass_earth=1.148,
                 orbital_period_d=12.353, semi_major_axis_au=0.04683,
                 star_teff_K=2566, star_radius_sun=0.1192, star_mass_sun=0.0898,
                 star_luminosity=0.000553, reference="Agol+2021"),

    CatalogEntry("TRAPPIST-1 h", "TRAPPIST-1",
                 radius_earth=0.755, mass_earth=0.331,
                 orbital_period_d=18.767, semi_major_axis_au=0.06189,
                 star_teff_K=2566, star_radius_sun=0.1192, star_mass_sun=0.0898,
                 star_luminosity=0.000553, reference="Agol+2021"),

    # ── Proxima Centauri (Anglada-Escudé et al. 2016) ─────────────────────────
    CatalogEntry("Proxima Cen b", "Proxima Centauri",
                 radius_earth=1.03, mass_earth=1.07,
                 orbital_period_d=11.186, semi_major_axis_au=0.0485,
                 star_teff_K=3042, star_radius_sun=0.1542, star_mass_sun=0.1221,
                 star_luminosity=0.00155, reference="Anglada-Escude+2016"),

    # ── LHS 1140 system (Dittmann et al. 2017; Ment et al. 2019) ─────────────
    CatalogEntry("LHS 1140 b", "LHS 1140",
                 radius_earth=1.635, mass_earth=6.98,
                 orbital_period_d=24.737, semi_major_axis_au=0.0936,
                 star_teff_K=3216, star_radius_sun=0.1952, star_mass_sun=0.1979,
                 star_luminosity=0.00296, reference="Ment+2019"),

    CatalogEntry("LHS 1140 c", "LHS 1140",
                 radius_earth=1.282, mass_earth=1.81,
                 orbital_period_d=3.778, semi_major_axis_au=0.02675,
                 star_teff_K=3216, star_radius_sun=0.1952, star_mass_sun=0.1979,
                 star_luminosity=0.00296, reference="Ment+2019"),

    # ── Kepler benchmark planets ──────────────────────────────────────────────
    CatalogEntry("Kepler-442 b", "Kepler-442",
                 radius_earth=1.34, mass_earth=2.34,
                 orbital_period_d=112.305, semi_major_axis_au=0.409,
                 star_teff_K=4402, star_radius_sun=0.598, star_mass_sun=0.609,
                 star_luminosity=0.112, reference="Torres+2015"),

    CatalogEntry("Kepler-62 e", "Kepler-62",
                 radius_earth=1.61, mass_earth=4.5,
                 orbital_period_d=122.387, semi_major_axis_au=0.427,
                 star_teff_K=4925, star_radius_sun=0.638, star_mass_sun=0.690,
                 star_luminosity=0.202, reference="Borucki+2013"),

    CatalogEntry("Kepler-62 f", "Kepler-62",
                 radius_earth=1.41, mass_earth=2.8,
                 orbital_period_d=267.291, semi_major_axis_au=0.718,
                 star_teff_K=4925, star_radius_sun=0.638, star_mass_sun=0.690,
                 star_luminosity=0.202, reference="Borucki+2013"),

    CatalogEntry("Kepler-186 f", "Kepler-186",
                 radius_earth=1.17, mass_earth=1.71,
                 orbital_period_d=129.944, semi_major_axis_au=0.432,
                 star_teff_K=3788, star_radius_sun=0.472, star_mass_sun=0.478,
                 star_luminosity=0.0405, reference="Quintana+2014"),

    # ── K2 and TESS discoveries ───────────────────────────────────────────────
    CatalogEntry("K2-18 b", "K2-18",
                 radius_earth=2.37, mass_earth=8.63,
                 orbital_period_d=32.940, semi_major_axis_au=0.1429,
                 star_teff_K=3503, star_radius_sun=0.4445, star_mass_sun=0.3593,
                 star_luminosity=0.0233, reference="Sarkis+2018"),

    CatalogEntry("TOI-700 d", "TOI-700",
                 radius_earth=1.144, mass_earth=1.72,
                 orbital_period_d=37.424, semi_major_axis_au=0.1633,
                 star_teff_K=3480, star_radius_sun=0.4191, star_mass_sun=0.4150,
                 star_luminosity=0.0231, reference="Gilbert+2020"),

    CatalogEntry("TOI-700 e", "TOI-700",
                 radius_earth=0.953, mass_earth=0.82,
                 orbital_period_d=27.812, semi_major_axis_au=0.1344,
                 star_teff_K=3480, star_radius_sun=0.4191, star_mass_sun=0.4150,
                 star_luminosity=0.0231, reference="Gilbert+2023"),

    CatalogEntry("GJ 667C c", "GJ 667C",
                 radius_earth=1.54, mass_earth=3.86,
                 orbital_period_d=28.155, semi_major_axis_au=0.1251,
                 star_teff_K=3350, star_radius_sun=0.420, star_mass_sun=0.330,
                 star_luminosity=0.0137, reference="Anglada-Escude+2013"),

    CatalogEntry("Ross 128 b", "Ross 128",
                 radius_earth=1.13, mass_earth=1.35,
                 orbital_period_d=9.877, semi_major_axis_au=0.0496,
                 star_teff_K=3192, star_radius_sun=0.1967, star_mass_sun=0.1685,
                 star_luminosity=0.00362, reference="Bonfils+2018"),

    CatalogEntry("Wolf 1061 c", "Wolf 1061",
                 radius_earth=1.66, mass_earth=4.25,
                 orbital_period_d=17.867, semi_major_axis_au=0.0890,
                 star_teff_K=3342, star_radius_sun=0.310, star_mass_sun=0.294,
                 star_luminosity=0.0100, reference="Wright+2016"),

    # ── Solar system reference (for comparison) ────────────────────────────────
    CatalogEntry("Earth", "Sun",
                 radius_earth=1.000, mass_earth=1.000,
                 orbital_period_d=365.25, semi_major_axis_au=1.000,
                 star_teff_K=5778, star_radius_sun=1.000, star_mass_sun=1.000,
                 star_luminosity=1.000, reference="Solar system"),

    CatalogEntry("Mars", "Sun",
                 radius_earth=0.532, mass_earth=0.107,
                 orbital_period_d=686.97, semi_major_axis_au=1.524,
                 star_teff_K=5778, star_radius_sun=1.000, star_mass_sun=1.000,
                 star_luminosity=1.000, reference="Solar system"),

    CatalogEntry("Venus", "Sun",
                 radius_earth=0.950, mass_earth=0.815,
                 orbital_period_d=224.70, semi_major_axis_au=0.723,
                 star_teff_K=5778, star_radius_sun=1.000, star_mass_sun=1.000,
                 star_luminosity=1.000, reference="Solar system"),
]
...
class KeplerCatalog:
    ...
    def score_all(self, verbose: bool = True) -> list[tuple[CatalogEntry, float, str]]:
        ...
        for i, entry in enumerate(self.entries):
            if verbose:
                print(f"  [{i+1:2d}/{len(self.entries)}] Scoring {entry.name}...",
                      end="\r", flush=True)
    ...
    def summary(self) -> str:
        ...
        lines.append("─" * 92)
        lines.append(f"  {len(self.entries)} planets  "
                     f"(sorted by Planet-RL habitability score)")
        return "\n".join(lines)
    ...
    def rl_training_candidates(self, min_score: float = 0.35) -> list[CatalogEntry]:
        ...
        """
        exoplanets = [e for e in self.entries
                      if e.host_star != "Sun"]
        scored = [(e, e.habitability_score()[0]) for e in exoplanets]
        return [e for e, s in sorted(scored, key=lambda x: -x[1])
                if s >= min_score]
