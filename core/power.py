...
class PowerModel:
    ...
    def __init__(self,
        ...
        self._orbital_dist = (orbital_dist_m
    ...
    def battery_capacity_Wh(self, bus_power_W: float,
        ...
        E_surplus = max(0.0, (self.peak_power_W - bus_power_W)
                        * self.sunlit_duration_s / 3600)
